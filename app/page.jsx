...
const App = () => {
  ...
  useEffect(() => {
    axios
      .get("http://127.0.0.1:1337/api/main-pages")
      .then(({ data }) => setMainPage(data.data))
  ...
  return (
    <>
      {mainPage.map(({ id, attributes }) => (
        <div key={id} className="hero" id="hero">
          <div className="m-auto">
            <div className="relative flex items-center justify-center gap-[120px]">
              <div className="flex flex-col leading-[1.2]">
                <h1 className="text-[4rem]">{attributes.heading}</h1>
                <p className="text-lg text-[#555]">{attributes.main_desc}</p>
            ...
            <div className="w-1/2 h-[6rem] flex items-center justify-between gap-[6px]">
              <div>
                <h1 className="border-r-2 pr-4 border-black">{attributes.tech_desc}</h1>
              </div>
